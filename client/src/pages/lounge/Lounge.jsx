...
const Lounge = () => {
  ...
  const { data, loading, error } = useFetch(`/lounges/find/${id}`);
        ...
        <div className="loungeContainer">
          ...
          <div className="loungeWrapper">
            ...
            <span className="loungePriceHighlight">
              Book a stay over ${data.cheapestPrice} at this lounge and get a free drink
            </span>
            ...
            <div className="loungeDetails">
              ...
              <div className="loungeDetailsPrice">
                ...
                <h2>
                  <b>${days * (data?.cheapestPrice || 0) * (options?.room || 1)}</b>
                </h2>
